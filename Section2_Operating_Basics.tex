...
\importantKeyword{/dev/cu.SLAB_USBtoUART}\\

\importantKeyword{/dev/tty.SLAB_USBtoUART} (on Mac).
...
... where \importantKeyword{file_path} is the full path to the special device file (e.g. \importantKeyword{/dev/ttyUSB0} or \importantKeyword{/dev/cu.SLAB_USBtoUART}).
