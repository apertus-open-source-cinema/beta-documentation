...
\consoleCommand{#stop HDMI stream:
fil\_reg 15 0
 
#capture image
./cmv\_snap3 -r -2 -e 10ms > image.raw12
...
\consoleCommand{pkg install package_name}
...
\consoleCommand{darkframe-xN.pgm
    dcnuframe-xN.pgm}
...
Edit the coordinates and the raw file name in \importantKeyword{calib\_argyll.sh} ( \href{https://github.com/apertus-open-source-cinema/misc-tools-utilities/blob/master/color-calibration/calib_argyll.sh}{https://github.com/apertus-open-source-cinema/misc-tools-utilities/blob/master/color-calibration/calib_argyll.sh} ). 
